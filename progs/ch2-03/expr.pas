...
type
  ...
  private
    ...
    writecallback: TWriteCallback;
  public
    charCountT, wordCountT, lineCountT : Integer;
    constructor Create;
...
// source: D:\Users\verhees\Documents\GitHub\NdYaccLexTool\tools\yyparse.cod line# 60
...
next:
  ...
  if (yyd[yystate]=0) and (yychar=-1) then
    ...
    begin
      ...
      wordCountT := wordCountT + lexer.wordCount;
      charCountT := charCountT + lexer.charCount;
      lineCountT := lineCountT + lexer.lineCount;
    end;
